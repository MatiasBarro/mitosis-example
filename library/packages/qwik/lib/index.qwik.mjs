...
const AutoComplete = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES$1, "AutoComplete_component_useStylesScoped_tEXUsxJuHxQ"));
  ...
  return /* @__PURE__ */ _jsxQ("div", null, {
    ...
    state.suggestions.length > 0 && state.showSuggestions ? /* @__PURE__ */ _jsxQ("ul", null, {
      ...
      return /* @__PURE__ */ _jsxQ("li", {
        ...
        item
      }, 3, "y7_0") : /* @__PURE__ */ _jsxQ("span", null, null, transform(props, state, item), 1, null), 0, idx);
    }), 1, "y7_1") : null
  ], 1, "y7_2");
...
const TodoApp = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES, "TodoApp_component_useStylesScoped_hoVByzZiE30"));
  const state = useStore({
    list: [
      "hello",
      "world"
