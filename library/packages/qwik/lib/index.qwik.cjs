...
const AutoComplete = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES$1, "AutoComplete_component_useStylesScoped_tEXUsxJuHxQ"));
  ...
  }, "AutoComplete_component_useTask_aoSBDyEwzTQ", [
    props,
    state
  ]));
  return /* @__PURE__ */ qwik._jsxQ("div", null, {
    ...
    /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      /* @__PURE__ */ qwik._jsxQ("input", {
        ...
        }, "AutoComplete_component_div_div_input_onChange_guaRRkff0pw", [
          state
        ]),
        onFocus$: /* @__PURE__ */ qwik.inlinedQrl((event) => {
          const [state2] = qwik.useLexicalScope();
          return state2.showSuggestions = true;
        }, "AutoComplete_component_div_div_input_onFocus_UQUVGHJqNIA", [
          state
        ])
      }, {
      ...
      /* @__PURE__ */ qwik._jsxQ("button", {
        ...
        }, "AutoComplete_component_div_div_button_onClick_2cVv8dqoHOM", [
          state
        ])
      }, {
    ...
    state.suggestions.length > 0 && state.showSuggestions ? /* @__PURE__ */ qwik._jsxQ("ul", null, {
      ...
      return /* @__PURE__ */ qwik._jsxQ("li", {
        ...
        }, "AutoComplete_component_div_ul_li_onClick_ic2bF2L6Oxs", [
          item,
          props,
          state
        ])
        ...
        item
      }, 3, "y7_0") : /* @__PURE__ */ qwik._jsxQ("span", null, null, transform(props, state, item), 1, null), 0, idx);
    }), 1, "y7_1") : null
  ], 1, "y7_2");
}, "AutoComplete_component_z925QVNlp0k"));
const STYLES$1 = `
.div-AutoComplete {
  padding: 10px;
  max-width: 700px;
...
const TodoApp = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES, "TodoApp_component_useStylesScoped_hoVByzZiE30"));
  const state = qwik.useStore({
    list: [
      "hello",
      "world"
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", null, {
    ...
    /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      /* @__PURE__ */ qwik._jsxQ("input", {
        ...
        }, "TodoApp_component_div_div_input_onChange_uIGPJY9ZbKE", [
          state
        ])
      }, {
        class: "input-TodoApp",
      ...
      /* @__PURE__ */ qwik._jsxQ("button", {
        ...
        }, "TodoApp_component_div_div_button_onClick_UWLpdb2Efvk", [
          props,
          state
        ])
      }, {
    ...
    /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      return /* @__PURE__ */ qwik._jsxQ("li", null, {
        ...
        /* @__PURE__ */ qwik._jsxQ("button", {
          ...
          }, "TodoApp_component_div_div_ul_li_button_onClick_cHuwkQpTLSc", [
            idx,
            props,
            state
          ])
...
const Greet = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", null, null, [
    /* @__PURE__ */ qwik._jsxQ("input", {
      ...
      }, "Greet_component_div_input_onChange_UcVp51dnJIQ", [
        state
      ])
    }, {
